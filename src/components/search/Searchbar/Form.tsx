/* eslint-disable react-hooks/rules-of-hooks, react-compiler/react-compiler -- useComponent is a misnamed HTMX URL builder from @decocms/apps, not a React hook */
/**
...
export default function Searchbar({
  ...
  return (
    <div className="grid w-full gap-8 px-4 py-6" style={{ gridTemplateRows: "min-content auto" }}>
      <form id={SEARCHBAR_INPUT_FORM_ID} action={ACTION} className="join" onSubmit={onSubmit}>
        <button
          type="submit"
          className="no-animation btn join-item btn-square"
          aria-label="Search"
        ...
        <input
          ...
          autoFocus
          tabIndex={0}
          className="input-bordered input join-item grow"
          name={NAME}
        ...
        />
        <label
          className="no-animation btn join-item hidden btn-square btn-ghost sm:inline-flex"
