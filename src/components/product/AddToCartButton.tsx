...
import { AnalyticsItem, Product } from "@decocms/apps/commerce/types";
...
function AddToCartButton(props: Props) {
  const { product, item, className: _class } = props;
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        disabled
        className={clx("flex-grow peer-checked:hidden", _class?.toString())}
      ...
      {/* Quantity Input */}
      <div className="grow hidden peer-checked:flex">
        <QuantitySelector
          disabled
          min={0}
          max={100}
